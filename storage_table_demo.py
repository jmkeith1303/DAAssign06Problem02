...
resourcegroup_name = 'jmk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'jmk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for 2006 Jeep Liberty...')
...
car.price = 45000
table_service.insert_entity('itemstable', car)
print('Created entry for 2017 Kia Sorrento...')
...
car.price = 22000
table_service.insert_entity('itemstable', car)
print('Created entry for 2017 Volkswagon Tiguan...\n')
...
car.price = 140000
table_service.insert_entity('itemstable', car)
print('Created entry for 2018 Tesla Model X...\n')
...
coffee.flavor = 'Mocha Latte'
coffee.cupsize = 'Grande'
coffee.cost = 4.45
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Starbucks Mocha Latte...\n')
time.sleep(1)
...
coffee.cost = 3.75
table_service.insert_entity('itemstable', coffee)
print('Created entry for Dunkin Donuts Dark Roast...\n')
...
coffee.cost = 3.25
table_service.insert_entity('itemstable', coffee)
print('Created entry for Einsteins Hazelnut...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffeeshop'", select='brand,flavor,cupsize,cost')
for item in items:
